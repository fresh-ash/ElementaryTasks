...
public class CustomerCountStrategyTest  extends BaseStrategyTest{
    ...
    public CustomerCountStrategyTest(Integer index, Integer value, boolean expectedResultForPredictFunction,
    ...
    public static Iterable input(){
        return Arrays.asList(new Object[][] {{0, 2, true, Arrays.asList(3,2,4,3), true},
                                            {0, 1, false, Arrays.asList(2,2,2,3), false}});
    }
